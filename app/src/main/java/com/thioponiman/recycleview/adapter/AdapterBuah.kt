package com.thioponiman.recycleview.adapter
...
import com.thioponiman.recycleview.databinding.ListItemBuahBinding
...
class AdapterBuah(private val context : Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            ListItemBuahBinding.inflate(LayoutInflater.from(parent.context), parent, false)
